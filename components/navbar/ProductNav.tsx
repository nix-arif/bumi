...
const ProductNav = () => {
  ...
  return (
    <li onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      ...
      <div
        className={`relative lg:absolute lg:flex -ml-5 bg-white border-2 rounded-md lg:py-4 py-2 transition ease-in duration-150 ${
      ...
      >
        ...
        <div className="lg:px-8 lg:pr-20 py-2 max-lg:pl-6">
          ...
          <ul className="text-sm">
            <li className="text-neutral-500 hover:text-blue-500 py-3">
